import Layout from "@/components/Layout"; // Adicionado Layout
import { Button } from "@/components/ui/button";
import { Search, MapPin, ArrowRight, Store } from "lucide-react"; // Adicionado Store
import { Link } from "react-router-dom";
import heroImage from "../assets/hero-praia.jpg";

const Index = () => {
  return (
    <Layout> {/* Envolvendo com Layout para mostrar Header/Footer */}
